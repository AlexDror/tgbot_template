...
import tgbot.misc.aiogoogletrans2.urls
import tgbot.misc.aiogoogletrans2.utils
from tgbot.misc.aiogoogletrans2.gtoken import TokenAcquirer
from tgbot.misc.aiogoogletrans2.constants import (
    DEFAULT_CLIENT_SERVICE_URLS,
    DEFAULT_FALLBACK_SERVICE_URLS,
    DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES,
    DEFAULT_RAISE_EXCEPTION, DUMMY_DATA
)
from tgbot.misc.aiogoogletrans2.models import Translated, Detected, TranslatedPart
...
class Translator:
    ...
    def __init__(self, service_urls=DEFAULT_CLIENT_SERVICE_URLS, user_agent=DEFAULT_USER_AGENT,
        ...
        self.client = aiohttp.ClientSession(version=aiohttp.HttpVersion11 if http2 else aiohttp.HttpVersion10)
        ...
        #     self.client.ATTRS. .timeout = timeout
    ...
    async def _translate(self, text: str, dest: str, src: str):
        url = tgbot.misc.aiogoogletrans2.urls.TRANSLATE_RPC.format(host=self._pick_service_url())
        data = {
    ...
    def translate_legacy(self, text, dest='en', src='auto', **kwargs):
        ...
        Basic usage:
            >>> from googletrans4 import Translator
