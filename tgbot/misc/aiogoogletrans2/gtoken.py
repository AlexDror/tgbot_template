...
from tgbot.misc.aiogoogletrans2.utils import rshift
...
class TokenAcquirer:
    ...
    def __init__(self, client: aiohttp.ClientSession, tkk='0', host='translate.google.com'):
        self.client = client
        self.tkk = tkk
    ...
    async def _update(self):
        ...
        try:
            ...
            code = self.RE_TKK.search(r).group(1).replace('var ', '')
